...
public class HelloApplication extends Application
{
    public void start(Stage stage) {
        ...
        Font fontBold = Font.font("Times New Roman",
                FontWeight.BOLD, FontPosture.REGULAR, 100);
        Font fontItalic = Font.font("Times New Roman",
                FontWeight.NORMAL, FontPosture.ITALIC, 100);
        Font fontNormal = Font.font("Times New Roman",
                FontWeight.NORMAL, FontPosture.REGULAR, 100);
        ...
        stage.setTitle("CheckboxDemo"); // Set the stage title
